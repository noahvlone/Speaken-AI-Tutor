...
export const AvatarControls: React.FC<AvatarControlsProps> = () => {
  ...
  return (
    <div className="flex flex-col gap-4 relative w-full items-center">
      <div className="flex flex-row items-center gap-4 w-full justify-center flex-wrap">
        <ToggleGroup
          className={`bg-gray-100 rounded-xl p-1 border border-gray-300 ${isVoiceChatLoading ? "opacity-50" : ""
            }`}
