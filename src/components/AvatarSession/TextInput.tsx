...
export const TextInput: React.FC = () => {
  ...
  return (
    <div className="flex flex-row gap-3 items-end w-full bg-white rounded-2xl p-4 border border-gray-300 shadow-sm">
      ...
      <Input
        className="flex-1 min-w-[300px] bg-white border-gray-300 text-gray-800 placeholder:text-gray-500"
      ...
      <Button 
        className="!p-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl"
        onClick={handleSend}
      >
        <SendIcon size={20} />
      </Button>
