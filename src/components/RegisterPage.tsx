...
import { signUp, signInWithGoogle } from '../utils/supabase/client';
              ...
              <div className="bg-white/40 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/60 shadow-2xl">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-12 h-14 rounded-xl bg-white/60 border-white/80 focus:border-purple-400 focus:ring-purple-400/20 ${errors.fullName ? 'border-red-400' : ''
                          }`}
                      />
                    </div>
                    {errors.fullName && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-12 h-14 rounded-xl bg-white/60 border-white/80 focus:border-purple-400 focus:ring-purple-400/20 ${errors.email ? 'border-red-400' : ''
                          }`}
                      />
                    </div>
                    {errors.email && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className={`pl-12 h-14 rounded-xl bg-white/60 border-white/80 focus:border-purple-400 focus:ring-purple-400/20 ${errors.password ? 'border-red-400' : ''
                          }`}
                      />
                    </div>
                    {errors.password && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className={`pl-12 h-14 rounded-xl bg-white/60 border-white/80 focus:border-purple-400 focus:ring-purple-400/20 ${errors.confirmPassword ? 'border-red-400' : ''
                          }`}
                      />
                    </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 h-12 rounded-xl bg-white/60 border border-gray-200 hover:bg-white hover:border-purple-400 transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isGoogleLoading ? (
