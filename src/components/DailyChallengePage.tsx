...
export function DailyChallengePage() {
  ...
  const handleStartQuest = (actionUrl: string) => {
    navigate(actionUrl);
  };
      ...
      <div className="max-w-5xl mx-auto space-y-8">
          ...
          <Card className="bg-gradient-to-br from-orange-500 to-red-600 text-white border-none shadow-lg">
            <CardContent className="p-6 flex flex-col justify-between h-full">
              <div className="flex justify-between items-start">
                ...
                <span className="text-xs font-medium bg-white/20 px-2 py-1 rounded-full">Current Streak</span>
              </div>
              <div>
                <div className="text-4xl font-bold mt-4">{currentStreak} days</div>
        ...
        <Tabs defaultValue="daily" className="w-full">
          <TabsList className="bg-slate-200/50 p-1 rounded-xl mb-6">
            ...
            <TabsTrigger value="achievements" className="rounded-lg px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:shadow-sm">Achievements</TabsTrigger>
          </TabsList>
            ...
            <div className="grid gap-4">
                  ...
                  <CardContent className="p-6 flex items-center gap-6">
                    ...
                    <div className="flex flex-col items-end gap-3 min-w-[100px]">
                      ...
                      <Button
                        ...
                        onClick={() => handleStartQuest(quest.action_url)}
              ...
              {quests.length === 0 && (
                <div className="text-center py-12 bg-white rounded-xl border border-slate-200">
                  <p className="text-slate-500">No active quests available right now.</p>
                </div>
              )}
            </div>
          </TabsContent>
          ...
          <TabsContent value="weekly">
            <div className="text-center py-12 bg-white rounded-xl border border-slate-200">
              <p className="text-slate-500">Weekly challenges coming soon!</p>
            </div>
          </TabsContent>

          <TabsContent value="achievements">
            <div className="text-center py-12 bg-white rounded-xl border border-slate-200">
              <p className="text-slate-500">Full achievement list coming soon!</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
